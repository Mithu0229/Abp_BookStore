...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 14d526a1-3355-46e4-b0c4-9db536fe7c11
```

> `14d526a1-3355-46e4-b0c4-9db536fe7c11` is the password of the certificate, you can change it to any password you want.
